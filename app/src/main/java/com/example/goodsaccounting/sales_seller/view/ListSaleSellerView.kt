        ...
        Column {
            ...
            if (sale.imagesUrl.size > 1){
                Row(
                    ...
                    for(index in sale.imagesUrl.indices){
                        ...
                        Spacer(modifier = Modifier.size(8.dp).background(animationColor, CircleShape))
                    }
                }
            }
            ...
            Column(
                ...
                Row(
                    ...
                    Text(
                        text = "${LocalDate.parse(sale.date)}",
                        maxLines = 1,
                        style = MaterialTheme.typography.body2,
                        color = MaterialTheme.colors.textColor.copy(0.6f),
                ...
                Spacer(modifier = Modifier.height(MaterialTheme.padding.small2))
                Text(
                    text = stringResource(R.string.sold) +": "+ sale.getMaterialsName(),
                    maxLines = 3,
                    style = MaterialTheme.typography.body2,
                    color = MaterialTheme.colors.textColor.copy(0.6f)
                )
